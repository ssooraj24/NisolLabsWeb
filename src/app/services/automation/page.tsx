...
import { Zap, ArrowRight, CheckCircle2, Layers, ArrowLeft } from "lucide-react";
import { Button } from "@/components/ui/Button";
import { Badge } from "@/components/ui/Badge";
import { SERVICES } from "@/data/services";

export const metadata: Metadata = {
  title: "AI-Powered Automation (IDP) | Nisol Labs",
  description: "Intelligent document processing, vision LLMs, and zero-touch automated workflow channels."
};
    ...
    <div className="space-y-16 py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="bg-navy-950 text-white rounded-3xl p-8 sm:p-12 border border-golden-500/30 shadow-2xl relative overflow-hidden">
        <div className="max-w-3xl space-y-6 relative z-10">
          <Badge variant="golden">INTELLIGENT WORKFLOWS</Badge>
          <h1 className="text-3xl sm:text-5xl font-black tracking-tight text-white leading-tight">
            AI-Powered <span className="golden-gradient-text">Automation</span>
          </h1>
