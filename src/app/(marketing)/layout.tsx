...
export const metadata: Metadata = {
  ...
  description:
    "Nisol Labs helps businesses become AI-First organizations through practical, scalable, outcome-driven AI solutions. Autonomous Agents, AI Engineering, LLMOps, Strategy, and RAG.",
  keywords: [
