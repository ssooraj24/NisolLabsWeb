...
export const metadata = {
  title: "AI for Small Businesses — Playbook | Nisol AI",
  description:
    "Discover how Nisol AI helps small businesses adopt AI with a proven 6-step methodology. Executive summary, industry stats, readiness quiz, transformation roadmap, and AI Discovery Workshop.",
};
