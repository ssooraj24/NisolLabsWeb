    ...
    <div className="space-y-24 py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 font-sans">
      ...
      <div className="relative text-center max-w-4xl mx-auto space-y-6 pt-8 pb-4">
        ...
        <p className="text-lg sm:text-xl text-navy-800 font-semibold max-w-3xl mx-auto leading-relaxed">
          Our Nisol 360™ engagement delivers <strong className="text-navy-950 font-black">15 executive-ready reports</strong> across three strategic packs.
        </p>
      ...
      <div className="space-y-12">
        <SectionHeader 
          ...
          description="See how a fixed-price Nisol 360™ replaces tech uncertainty with structured transformation confidence."
