...
const smallBusinessPlaybook: Playbook = {
  ...
  hero: {
    ...
    subtitle: 'A practical, affordable guide to AI adoption for solopreneurs, startups, and SMBs.',
    image: '/images/hero-small-business.jpg',
    roi: '300–600%',
    timeline: '2–8 Months',
  ...
  From automating customer service to generating marketing content and analysing financials, you’ll discover how to start small, learn fast, and scale wisely.`,
  challenges: [
    { title: 'Limited Marketing Budget' },
    { title: 'Customer Service Overhead' },
  ...
  featuredSolutions: [
    {
      ...
      solution: 'Deploy an AI chatbot on your website and social channels to answer FAQs, book calls, and qualify leads.',
    ...
    },
    {
      ...
      businessProblem: 'Creating blogs, emails, and social posts consistently is time‑consuming and expensive.',
      solution: 'AI generates on‑brand content drafts, social captions, and email sequences based on your voice and keywords.',
  ...
  maturityJourney: ['Current State', 'Exploring AI', 'Pilot Projects', 'Department AI', 'Enterprise AI', 'AI‑Driven Business'],
  roadmap: [
    { month: 'Week 1', milestone: 'Free AI Discovery Call – identify quick wins' },
    { month: 'Week 2', milestone: 'Deploy chatbot on website (first client interaction)' },
    { month: 'Month 1', milestone: 'Roll out content generation for social media' },
    { month: 'Month 3', milestone: 'Automate lead scoring and financial analysis' },
    { month: 'Month 8', milestone: 'Full AI stack with custom agents' },
  ],
  businessBenefits: [
    'Save Time',
    'Reduce Costs',
  ...
  services: [
    { name: 'AI Discovery Workshop (SMB)', description: 'Affordable 2‑hour session to map your AI roadmap.', link: '/services/smb-workshop' },
    { name: 'AI Accelerator Package', description: 'Chatbot + Content AI + Lead Scoring bundle.', link: '/services/smb-accelerator' },
    { name: 'Ongoing AI Support', description: 'Monthly check‑ins and model tuning as you grow.', link: '/services/smb-support' },
  ],
  faq: [
    { q: 'How much does AI cost for a small business?', a: 'We offer entry‑level packages starting at $2,500 for a chatbot deployment, and full suites from $8,000.' },
    { q: 'Do I need technical skills to use these tools?', a: 'No. We build everything for you and provide easy‑to‑use dashboards. You just manage your business.' },
    { q: 'What if I don’t have much data?', a: 'Many AI tools work well with minimal historical data. We leverage pre‑trained models and your existing documents.' },
    { q: 'How fast can I see results?', a: 'Chatbots and content tools show value in the first week. ROI is typically visible within 30 days.' },
  ],
};
